...
wandb.config.update({"embedding_n_tokens": 143}, allow_val_change=True)
...
checkpoint = r"training_checkpoints/23-06-2022/soft-opt-epoch=029-val_loss=0.397-embedding_n_tokens=143.ckpt"
